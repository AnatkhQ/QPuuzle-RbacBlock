...
class Permission(models.Model):
    ...
    menu = models.ForeignKey(verbose_name='所属菜单', to='Menu', null=True, blank=True, help_text='null表示不是一级菜单;非null表示是二级菜单',
...
class UserInfo(models.Model):
    ...
    # to=Role不加引号，因为该类被继承后如果加了引号则找不到Role，'Role'找的是该py文件中的类，不能跨文件
